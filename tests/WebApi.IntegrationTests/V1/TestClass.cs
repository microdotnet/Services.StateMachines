...
public partial class TestClass : TestClassBase, IClassFixture<CustomWebApplicationFactory<WebApiProgram>>
{
    private readonly CustomWebApplicationFactory<WebApiProgram> customWebApplicationFactory;

    private readonly HttpClient client;

    public TestClass(CustomWebApplicationFactory<WebApiProgram> customWebApplicationFactory)
    {
