...
internal class MongoMachineDefinitionsRepository : MongoCollectionRepositoryBase<MachineDefinitionDto, (string Code, short Version)>, IMachineDefinitionsRepository
{
    ...
    public async Task<OneOf<CreateMachineDefinitionResponse, Error>> CreateMachineDefinitionAsync(CreateMachineDefinitionRequest request, CancellationToken cancellationToken)
    {
    ...
    public async Task<OneOf<GetMachineDefinitionResponse, Error>> GetMachineDefinitionAsync(GetMachineDefinitionRequest request, CancellationToken cancellationToken)
    {
    ...
    public async Task<OneOf<UpdateMachineDefinitionResponse, Error>> UpdateMachineDefinitionAsync(UpdateMachineDefinitionRequest request, CancellationToken cancellationToken)
    {
